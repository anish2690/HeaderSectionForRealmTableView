//
//  GrouppedDateTableVC.swift
//  RealmGroupedTableView
//
//  Created by Anish George on 21/10/17.
...
class GrouppedDateTableVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        print("objectsBySection \(objectsBySection)")
    }
    ...
    func setupUI() {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "BG Add", style: .plain, target: self, action: #selector(ViewController.backgroundAdd))
    ...
    @objc func backgroundAdd() {
        ...
        DispatchQueue.global().async {
            ...
            for _ in 0..<5 {
                ...
                print("Random section titile \(self.randomSectionTitle())")
            }
